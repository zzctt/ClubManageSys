...
List<Activity> al = (List<Activity>) session.getAttribute("activitysTonKey");
%>
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">查看活动</a>
                </div>
            </div>
        </nav>		
                            ...
                            <div class="content table-responsive table-full-width">
								<table class="table table-hover">
									<tbody>
										...
										%>
										<tr>
											<td><img src="<%=a.getTupian() %>" width="200px" height="150px"></td>
											<td><%=a.getZhuti() %></td>
											<td><%=a.getShijian() %></td>
											<td><%=a.getDidian() %></td>
											<td><%=a.getGuanjianzi() %></td>
											<td><a href="activityTran.action?activityId=<%=a.getActivityId() %>">查看</a></td>
										</tr>
										<%
											}
										%>
