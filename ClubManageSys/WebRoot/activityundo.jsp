...
List<Activity> al = (List<Activity>) session.getAttribute("activitysBuKey");
%>
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">未通过活动</a>
                </div>
            </div>
        </nav>		
								...
								<table class="table table-hover">
									<tbody>
										...
										<tr>
											...
											<td><%=a.getZhuti() %></td>
											<td><%=a.getJubanfang() %></td>
											<td><%=a.getGaishu() %></td>
											<td><a href="activityUn?activityId=<%=a.getActivityId() %>">修改</a></td>
										</tr>
										<%
											}
										%>
